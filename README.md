...
Row and compact Back hover entry use explicit .lui presentation transitions. Press, selection and keyboard focus remain immediate; reduced motion suppresses cosmetic interpolation. The shell opts into nearest-available focus recovery across responsive hiding without replaying old focus when a pane returns. Managed consumer tests cover hover/press, retained drafts and editor sessions; the published focus fixture exercises physical wide/narrow/wide navigation.
